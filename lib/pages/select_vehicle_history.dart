...
class SelectVehicleHistory extends StatefulWidget {
  ...
  const SelectVehicleHistory({Key key, @required this.jsonData})
      : super(key: key);
  @override
  _SelectVehicleHistoryState createState() => _SelectVehicleHistoryState();
}
                  ...
                  onTap: () {
                    if (Provider.of<Data>(context, listen: false)
                      ...
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) =>
                                  History(jsonData: widget.jsonData)));
                    }
                  },
                  child: Container(
