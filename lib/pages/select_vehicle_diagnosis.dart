...
import 'package:ion_it/pages/diagnosis_support.dart';
import 'package:provider/provider.dart';

class SelectVehicleDiagnosis extends StatefulWidget {
  final String jsonData;

  const SelectVehicleDiagnosis({Key key, @required this.jsonData})
      : super(key: key);

  @override
  _SelectVehicleDiagnosisState createState() => _SelectVehicleDiagnosisState();
}

class _SelectVehicleDiagnosisState extends State<SelectVehicleDiagnosis> {
                ...
                onTap: () {
                  if (Provider.of<Data>(context, listen: false)
                    ...
                    Navigator.pushReplacement(
                        ...
                        MaterialPageRoute(
                            builder: (context) =>
                                DiagnosisPage(jsonData: widget.jsonData)));
                  }
                },
                child: Container(
                      ...
                      itemBuilder: (ctx, i) => GestureDetector(
                          onTap: () {
                            Provider.of<Data>(context, listen: false)
                                .changeDiagnosisVehicle(
                                    snapshot.data[idList[i]][0], idList[i]);
                          },
                          child: Container(
